...
import 'application/fetch_yarns_worsted_wool/fetch_worsted_wool_yarns_bloc.dart'
    as _i32;
import 'application/forgot_password/forgot_password_bloc.dart' as _i33;
import 'application/profile/profile_bloc.dart' as _i36;
import 'application/reset_password/reset_password_bloc.dart' as _i38;
...
import 'config/production.config.dart' as _i9;
import 'config/staging.config.dart' as _i8;
import 'domain/ports/bank_details_repo.dart' as _i56;
import 'domain/ports/business_details_repo.dart' as _i58;
import 'domain/ports/file_repo.dart' as _i60;
import 'domain/ports/firebase_repo.dart' as _i34;
import 'domain/ports/suggestion_repo.dart' as _i62;
import 'domain/ports/user_repo.dart' as _i79;
import 'domain/ports/yarn_repo.dart' as _i64;
import 'domain/use_cases/add_new_user.dart' as _i85;
import 'domain/use_cases/add_suggestion.dart' as _i70;
import 'domain/use_cases/add_yarn_requirement.dart' as _i71;
import 'domain/use_cases/cache_logged_in_user.dart' as _i83;
import 'domain/use_cases/check_phone_number.dart' as _i86;
import 'domain/use_cases/clear_logged_in_user.dart' as _i87;
import 'domain/use_cases/delete_file.dart' as _i72;
import 'domain/use_cases/fetch_saved_user_bank_details.dart' as _i73;
import 'domain/use_cases/fetch_saved_user_basic_information.dart' as _i88;
...
import 'domain/use_cases/fetch_user_basic_information_by_phone_number.dart'
    as _i89;
import 'domain/use_cases/fetch_user_by_id.dart' as _i90;
import 'domain/use_cases/fetch_user_yarns.dart' as _i75;
import 'domain/use_cases/fetch_users_by_type.dart' as _i91;
import 'domain/use_cases/fetch_yarn_by_category.dart' as _i76;
import 'domain/use_cases/fetch_yarns_of_user.dart' as _i77;
import 'domain/use_cases/get_file_download_link.dart' as _i78;
import 'domain/use_cases/load_logged_in_user.dart' as _i81;
import 'domain/use_cases/request_firebase_phone_auth_code.dart' as _i37;
import 'domain/use_cases/sign_in_user.dart' as _i82;
import 'domain/use_cases/update_user_bank_details.dart' as _i66;
import 'domain/use_cases/update_user_basic_info.dart' as _i84;
import 'domain/use_cases/update_user_business_details.dart' as _i67;
import 'domain/use_cases/upload_file.dart' as _i68;
...
import 'infrastructure/datasources/user_cache_datasource.dart' as _i69;
...
import 'infrastructure/repos/file_repo_impl.dart' as _i61;
import 'infrastructure/repos/firebase_repo_impl.dart' as _i35;
import 'infrastructure/repos/suggestion_repo_impl.dart' as _i63;
import 'infrastructure/repos/user_repo_impl.dart' as _i80;
import 'infrastructure/repos/yarn_repo_impl.dart' as _i65;
import 'injection.dart' as _i92;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i6.Config>(() => _i8.StagingConfig(),
      registerFor: {_staging});
  gh.lazySingleton<_i6.Config>(() => _i9.ProductionConfig(),
  ...
  gh.lazySingleton<_i33.ForgotPasswordBloc>(() => _i33.ForgotPasswordBloc());
  gh.lazySingleton<_i34.IFirebaseRepo>(() => _i35.FireBaseRepo());
  gh.lazySingleton<_i36.ProfileBloc>(() => _i36.ProfileBloc());
  gh.lazySingleton<_i37.RequestFirebasePhoneAuthCode>(
      () => _i37.RequestFirebasePhoneAuthCode(get<_i34.IFirebaseRepo>()));
  gh.lazySingleton<_i38.ResetPasswordBloc>(() => _i38.ResetPasswordBloc());
  ...
  gh.lazySingleton<_i49.VerifyFirebasePhoneAuthCode>(
      () => _i49.VerifyFirebasePhoneAuthCode(get<_i34.IFirebaseRepo>()));
  ...
  gh.lazySingleton<_i55.FileCrudDatasource>(() => _i55.FileLoopbackDatasource(
      get<_i39.RestDataSource>(), get<_i6.Config>()));
  ...
  gh.lazySingleton<_i60.IFileRepo>(
      () => _i61.FileRepoImpl(get<_i55.FileCrudDatasource>()));
  gh.lazySingleton<_i62.ISuggestionRepo>(
      () => _i63.SuggestionRepoImpl(get<_i47.SuggestionCrudDatasource>()));
  gh.lazySingleton<_i64.IYarnRepo>(
      () => _i65.YarnRepoImpl(get<_i50.YarnCrudDataSource>()));
  gh.factory<_i66.UpdateUserBankDetail>(
      () => _i66.UpdateUserBankDetail(get<_i56.IBankDetailsRepo>()));
  gh.lazySingleton<_i67.UpdateUserBusinessDetails>(
      () => _i67.UpdateUserBusinessDetails(get<_i58.IBusinessDetailsRepo>()));
  gh.lazySingleton<_i68.UploadFile>(
      () => _i68.UploadFile(get<_i60.IFileRepo>()));
  gh.lazySingleton<_i69.UserCacheDataSource>(
      () => _i69.UserCacheDataSource(get<_i53.CacheDataSource>()));
  gh.lazySingleton<_i70.AddSuggestion>(
      () => _i70.AddSuggestion(get<_i62.ISuggestionRepo>()));
  gh.lazySingleton<_i71.AddYarnRequirement>(
      () => _i71.AddYarnRequirement(get<_i64.IYarnRepo>()));
  gh.lazySingleton<_i72.DeleteFile>(
      () => _i72.DeleteFile(get<_i60.IFileRepo>()));
  gh.lazySingleton<_i73.FetchSavedUserBankDetails>(
      () => _i73.FetchSavedUserBankDetails(get<_i56.IBankDetailsRepo>()));
  gh.lazySingleton<_i74.FetchSavedUserBusinessDetails>(() =>
      _i74.FetchSavedUserBusinessDetails(get<_i58.IBusinessDetailsRepo>()));
  gh.lazySingleton<_i75.FetchUserYarns>(
      () => _i75.FetchUserYarns(get<_i64.IYarnRepo>()));
  gh.lazySingleton<_i76.FetchYarnByCategory>(
      () => _i76.FetchYarnByCategory(get<_i64.IYarnRepo>()));
  gh.lazySingleton<_i77.FetchYarnsOfUser>(
      () => _i77.FetchYarnsOfUser(get<_i64.IYarnRepo>()));
  gh.lazySingleton<_i78.GetFileDownloadLink>(
      () => _i78.GetFileDownloadLink(get<_i60.IFileRepo>()));
  gh.lazySingleton<_i79.IUserRepo>(() => _i80.UserRepoImpl(
      get<_i48.UserCrudDatasource>(), get<_i69.UserCacheDataSource>()));
  gh.lazySingleton<_i81.LoadLoggedInUser>(
      () => _i81.LoadLoggedInUser(get<_i79.IUserRepo>()));
  gh.lazySingleton<_i82.SignInUser>(
      () => _i82.SignInUser(get<_i79.IUserRepo>()));
  gh.lazySingleton<_i83.UpdateCacheLoggedInUser>(
      () => _i83.UpdateCacheLoggedInUser(get<_i79.IUserRepo>()));
  gh.lazySingleton<_i84.UpdateUserBasicInfo>(
      () => _i84.UpdateUserBasicInfo(get<_i79.IUserRepo>()));
  gh.lazySingleton<_i85.AddNewUser>(
      () => _i85.AddNewUser(get<_i79.IUserRepo>()));
  gh.lazySingleton<_i86.CheckPhoneNumber>(
      () => _i86.CheckPhoneNumber(get<_i79.IUserRepo>()));
  gh.lazySingleton<_i87.ClearLoggedInUser>(
      () => _i87.ClearLoggedInUser(get<_i79.IUserRepo>()));
  gh.lazySingleton<_i88.FetchSavedUserBasicInformation>(
      () => _i88.FetchSavedUserBasicInformation(get<_i79.IUserRepo>()));
  gh.lazySingleton<_i89.FetchUserBasicInformationByPhoneNumber>(
      () => _i89.FetchUserBasicInformationByPhoneNumber(get<_i79.IUserRepo>()));
  gh.lazySingleton<_i90.FetchUsersById>(
      () => _i90.FetchUsersById(get<_i79.IUserRepo>()));
  gh.lazySingleton<_i91.FetchUsersByType>(
      () => _i91.FetchUsersByType(get<_i79.IUserRepo>()));
  return get;
}
