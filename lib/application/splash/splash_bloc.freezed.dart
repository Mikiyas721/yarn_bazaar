...
abstract class $SplashStateCopyWith<$Res> {
  ...
  $Res call({Option<AppUser> appUser});
}
...
class _$_SplashState implements _SplashState {
  const _$_SplashState({required this.appUser});
  ...
  @override
  String toString() {
    return 'SplashState(appUser: $appUser)';
  }
...
abstract class _SplashState implements SplashState {
  const factory _SplashState({required final Option<AppUser> appUser}) =
      _$_SplashState;
